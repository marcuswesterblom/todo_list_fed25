import { saveTodosOrder, saveToLocalStorage } from "./storage.js";
import { updateVisability } from "./visability.js";

// Function for every todo
export const todoList = (todo, index, todos, ul, finishedList, containerList, containerFinished, youAreDoneText) => {
        // Create li
        ...
        updateVisability(todo, li, text, ul, finishedList, containerList, containerFinished, youAreDoneText);
        ...
        upBttn.addEventListener("click", () => {
            ...
            if(before) {
                ...
                saveTodosOrder(ul, finishedList, todos);
            }
        });
